...
export default async function editMethodMin(conversation, ctx) {
    ...
    const sent = await ctx.reply(`Выберите минимальную сумму для метода <b>${method.label}</b>:
